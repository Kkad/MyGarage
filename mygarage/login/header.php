...
<title>MyGarage Dashboard</title>
...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="dashboard.php"><span> MyGarage </span>Admin Area</a>
				<ul class="user-menu">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<a class="nav menu" href="#">
                    <img src="img/Bugatti-logo-1024x768.png" alt="" height="200" width="180" style="margin-left: 9%; margin-top: 3%; "></a>
		<br></div>
   ...
   if($userRow['u_type']=="Admin") 
			echo '<li><a href="manage_admins.php"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg>Manage Admins</a></li><li role="presentation" class="divider"></li>';
		  ?>
  			<li><a href=""><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg>Manage Clients</a></li><li role="presentation" class="divider"></li>
